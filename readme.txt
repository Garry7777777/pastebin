...
pastebin.com — сервис позволяет заливать куски текста/кода ("пасту") и получать
на них короткую ссылку, которую можно отправить другим людям.
...
в том числе и автору, нужно предусмотреть механизм удаления по таймеру.
